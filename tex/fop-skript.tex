...
\providecommand{\functional}{%
	\begin{tcolorbox}[standard jigsaw, colframe = functionalmarker, colback = tud2a, width = 2.5cm, height = 1.2cm, left = 5pt, boxrule = 3pt, opacityback = 0.8]
		Funktional
	\end{tcolorbox}
}
\providecommand{\imperative}{%
	\begin{tcolorbox}[standard jigsaw, colframe = imperativemarker, colback = tud4a, width = 2.5cm, height = 1.2cm, left = 7pt, boxrule = 3pt, opacityback = 0.8]
		\centering Imperativ
	\end{tcolorbox}
}
\providecommand{\oop}{%
	\begin{tcolorbox}[standard jigsaw, colframe = oopmarker, colback = tud6a, width = 3.5cm, height = 1.2cm, left = 6pt, boxrule = 3pt, opacityback = 0.8]
